...
VSTBRIDGE_API int  VST_ProbePluginAllClasses(const wchar_t* plugin_path, VstPluginProbeInfo* infos, int max_count, int* actual_count);
...
VSTBRIDGE_API int  VST_AddPlugin(VstChainKind kind, const wchar_t* plugin_path, const wchar_t* plugin_cid);
